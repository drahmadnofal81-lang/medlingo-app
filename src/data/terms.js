  ...
  anatomy: {
    cardiac: [
      ...
      },
      {
        en: "Coronary Artery",
        ar: "الشريان التاجي",
        definition: "An artery that supplies the heart muscle with oxygen-rich blood.",
        example: "Coronary arteries bring oxygen to the myocardium.",
        image: "/images/terms/cardiac/coronary_artery.png",
        quizQuestions: [
          {
            question: "What does Coronary Artery mean?",
            options: {
              A: "An artery that supplies blood to the heart muscle",
              B: "The main artery from the heart to the body",
              C: "The artery from the heart to the lungs",
              D: "The thin lining inside the heart",
            },
            correctAnswer: "A",
            explanation: "Coronary arteries supply oxygen-rich blood to the myocardium.",
          },
          {
            question: "Which English term matches this Arabic translation?",
            prompt: "الشريان التاجي",
            options: {
              A: "Aorta",
              B: "Coronary Artery",
              C: "Pulmonary Artery",
            ...
            correctAnswer: "B",
            explanation: "الشريان التاجي means Coronary Artery.",
          },
        ],
      },
      {
