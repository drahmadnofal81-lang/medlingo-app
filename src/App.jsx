...
const SUBTABS = {
  anatomy: [
    ...
    { id: "joints",       label: "🦵 المفاصل", en: "Joints" },
  ],
  physiology: [
...
function RegisterPage({ onRegister, onNavigate, savedUser }) {
  ...
  function validate() {
    const e = {};
    const hasLetter = value => /[A-Za-z\u0600-\u06FF]/.test(value);
    const values = getTrimmedFormValues();
  ...
  async function handleSubmit() {
    ...
    const registrationData = getTrimmedFormValues();
